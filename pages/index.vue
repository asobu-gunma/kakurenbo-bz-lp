        ...
        v-col(cols="6")
          ...
          v-row.mb-3(dense)
            ...
            v-col(cols="9") 
              .font-weight-bold
                span.me-3 赤堀体育館
                span.unit 〒379-2204 群馬県伊勢崎市西久保町２丁目８１
          v-row.mb-3(dense)
            v-col(cols="3")
          ...
          v-row(dense)
            ...
            v-col(cols="9")
              .event-schedule
                ul.timeline.caption.font-weight-bold
                  li.schedule
                    .tl-item
                      span.me-3 9:30~10:00
                      span 会場 / 受付
                  li.schedule
                    .tl-item
                      span.me-3 10:00~10:30
                      span 挨拶、ルール説明、準備運動
                  li.schedule
                    .tl-item
                      span.me-3 10:30~12:00
                      span スポーツかくれんぼ実施
                  li.schedule
                    .tl-item
                      span.me-3 12:00~12:30
                      span 表彰、クロージング
      v-btn.border-bold.font-weight-bold(
        tile
        outlined
